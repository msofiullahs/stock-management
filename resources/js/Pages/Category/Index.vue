...
const userProps = usePage().props.auth.user.access_items.category;
...
<template>
    <AppLayout title="Product Categories">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            ...
            <button v-if="userProps.includes('add')" type="button" class="btn btn-outline-light" @click="formCat(0, null)">Add</button>
        </div>
                ...
                <tbody>
                    <tr v-for="item in categories.data" :key="item.id">
                        ...
                        <td class="text-center">
                            <button v-if="userProps.includes('edit')" type="button" class="btn btn-sm p-0" style="line-height: 1;" @click="formCat(item.id, item.category_name)">
